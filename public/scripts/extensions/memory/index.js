...
$(document).ready(function () {
    function addExtensionControls() {
        ...
        <div id="memory_settings">
            <h3>메모리</h3>
            <label for="memory_contents">메모리 내용</label>
            <textarea id="memory_contents" class="text_pole" rows="8" placeholder="여기에 내용을 작성해주세요..."></textarea>
            <div class="memory_contents_controls">
                <input id="memory_restore" class="menu_button" type="submit" value="이전 상태 복원" />
                <label for="memory_frozen"><input id="memory_frozen" type="checkbox" />사용 중지</label>
            </div>
            <div class="inline-drawer">
                ...
                <div class="inline-drawer-content">
                    <br><label for="memory_short_length">메모리 요약 (단기 기억) 길이 : <span id="memory_short_length_tokens"></span> tokens</label>
                    ...
                    <label for="memory_long_length">메모리 컨텍스트 (장기 기억) 길이 : <span id="memory_long_length_tokens"></span> tokens</label>
                    ...
                    <label for="memory_temperature">AI 요약 창의력 : <span id="memory_temperature_value"></span></label>
                    ...
                    <label for="memory_repetition_penalty">짧은 대화에서 반복 패널티 : <span id="memory_repetition_penalty_value"></span></label>
                    ...
                    <label for="memory_length_penalty">전체 대화에서 반복 패널티 : <span id="memory_length_penalty_value"></span></label>
